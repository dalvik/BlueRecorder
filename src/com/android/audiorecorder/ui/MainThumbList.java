...
public class MainThumbList extends Activity {
	...
	private void initHeadView() {
		...
		mHeadLogo.setImageResource(R.drawable.lib_drawable_common_actionbar_back_selector);
    ...
    private View.OnClickListener frameFileBtnClick(final Button btn,final int catalog){
    ...
    private void initRemoteVideoListView() {
        ...
        remoteVideoListView.setOnScrollListener(new AbsListView.OnScrollListener() {
            public void onScrollStateChanged(AbsListView view, int scrollState) {
    ...
    private void initRemoteAudioListView() {
        ...
        remoteAudioListView.setOnScrollListener(new AbsListView.OnScrollListener() {
            public void onScrollStateChanged(AbsListView view, int scrollState) {
    ...
    private void initLocalOtherListView() {
        ...
        localOtherListView.setOnScrollListener(new AbsListView.OnScrollListener() {
            public void onScrollStateChanged(AbsListView view, int scrollState) {
